 ...
 */
(function (a) {
	a.tools = a.tools || {version: "v1.2.7"}, a.tools.gmTabs = {conf: {gmTabs: "a", current: "current", onBeforeClick: null, onClick: null, effect: "default", initialEffect: !1, initialIndex: 0, event: "click", rotate: !1, slideUpSpeed: 400, slideDownSpeed: 400, history: !1}, addEffect: function (a, c) {
		b[a] = c
	}};
	...
	a.tools.gmTabs.addEffect("horizontal", function (b, e) {
		if (!c) {
	...
	function e(c, d, e) {
		var f = this, g = c.add(this), h = c.find(e.gmTabs), i = d.jquery ? d : c.children(d), j;
		h.length || (h = c.children()), i.length || (i = c.parent().find(d)), i.length || (i = a(d)), a.extend(this, {click: function (d, i) {
			var k = h.eq(d), l = !c.data("gmTabs");
		...
		}), location.hash && e.gmTabs == "a" && c.find("[href=\"" + location.hash + "\"]").length ? f.click(location.hash) : (e.initialIndex === 0 || e.initialIndex > 0) && f.click(e.initialIndex)
	}

	a.fn.gmTabs = function (b, c) {
		var d = this.data("gmTabs");
		d && (d.destroy(), this.removeData("gmTabs")), a.isFunction(c) && (c = {onBeforeClick: c}), c = a.extend({}, a.tools.gmTabs.conf, c), this.each(function () {
			d = new e(a(this), b, c), a(this).data("gmTabs", d)
		});
		return c.api ? d : this
	}
})(jQuery);
