	...
	<div class="panel-heading clearfix">
		...
		<div class="btn-toolbar pull-left">
			...
			<?php if(('gmedia_category' != $taxonomy)){ ?>
				...
				<form class="btn-group" id="gm-selected-btn" name="gm-selected-form" action="<?php echo add_query_arg(array(
					'term' => $taxonomy,
					'filter' => 'selected'
				), $url); ?>" method="post">
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="<?php echo add_query_arg(array(
									'page' => 'GrandMedia',
									'alb' => $term->term_id
								), admin_url('admin.php')); ?>"><?php _e('Show Album in Gmedia Library', 'gmLang'); ?></a></li>
						</ul>
					</div>
				</div>
