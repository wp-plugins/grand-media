<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		...
		$settings = array_merge($settings,
			array('ID' => $gallery['term_id'], 'moduleUrl' => $module['url'], 'pluginUrl' => $gmCore->gmedia_url, 'libraryUrl' => $gmCore->upload['url'], 'key' => $gmGallery->options['license_key2'])
		);
		?>
		...
		GmediaGallery_<?php echo $gallery['term_id']; ?> = jQuery('#GmediaGallery_<?php echo $gallery['term_id'] ?>').gmSlider([content, settings]);
	});
</script>
